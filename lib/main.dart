...
import 'package:arch_flutter/screens/bloc/user_bloc_screen.dart';
import 'package:arch_flutter/screens/scoped_model/user_model_screen.dart';
import 'package:arch_flutter/screens/vanilla/vanilla_screen.dart';
...
class HomePage extends StatelessWidget {
    ...
    Widget build(BuildContext context) {
        return Scaffold(
            appBar: AppBar(
                title: const Text('Arquitecturas Flutter'),
            ),
            body: SafeArea(
                child: Padding(
